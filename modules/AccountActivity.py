...
class ActivityAPI(tweepy.API):
      ...
      def reenable_activity(self, *args, **kwargs):
          """ :reference: https://developer.twitter.com/en/docs/accounts-and-users/subscribe-account-activity/api-reference/aaa-premium
              :allowed_param:'url', 'env', 'webhookid'
          """
          put_data = {}
          env = kwargs.pop('env')
          webhookid = kwargs.pop('webhookid')
          apiPath = '/account_activity/all/'+env+'/webhooks/'+webhookid+'.json'
